...
THREE.CSS3DRenderer = function () {
	...
	var getCameraCSSMatrix = function ( matrix ) {
		...
		elements = [matrix.n11,matrix.n12,matrix.n13,matrix.n14,matrix.n21,matrix.n22,matrix.n23,matrix.n24,
		           matrix.n31,matrix.n32,matrix.n33,matrix.n34,matrix.n41,matrix.n42,matrix.n43,matrix.n44]
	...
	this.render = function ( scene, camera ) {
		...
		var fov = 0.5 / Math.tan( .017453292519943295*camera.fov * 0.5 ) * _height;
